...
def main() -> None:
    nb = {
        "cells": [
            {
                "cell_type": "markdown",
                "metadata": {"id": "kaggle-util-1", "language": "markdown"},
                "source": [
                    "# VECTRA — Kaggle Utility Notebook\n",
                    "\n",
            ...
            },
            {
                ...
                "metadata": {"id": "kaggle-util-2", "language": "python"},
                "outputs": [],
                "source": [
            ...
            },
            {
                "cell_type": "code",
                "execution_count": None,
                "metadata": {"id": "kaggle-util-3", "language": "python"},
                "outputs": [],
                "source": [
            ...
            },
            {
                "cell_type": "code",
                "execution_count": None,
                "metadata": {"id": "kaggle-util-4", "language": "python"},
                "outputs": [],
                "source": [
    ...
    out_path = Path("kaggle_vectra_utility.ipynb")
